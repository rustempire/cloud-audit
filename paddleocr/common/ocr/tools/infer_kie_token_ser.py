...
from common.ocr.ppocr import create_operators, transform
...
from common.ocr.ppocr import draw_ser_results
from common.ocr.ppocr import get_image_file_list
import common.ocr.tools.program as program
...
if __name__ == '__main__':
    ...
    with open(os.path.join(config['Global']['save_res_path'], "infer_results.txt"), "w", encoding='utf-8') as fout:
        for idx, info in enumerate(infer_imgs):
            ...
            fout.write(img_path + "\t" + json.dumps({"ocr_info": result,}, ensure_ascii=False) + "\n")
